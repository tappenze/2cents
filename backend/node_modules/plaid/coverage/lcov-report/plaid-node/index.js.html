...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">plaid-node/</a> index.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">87.12% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>203/233</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>197/222</span>
      </div>
    </div>
  </div>
...
667
668
669</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="fstat-no" title="function not covered" ><span class="branch-3 cbranch-no" title="branch not covered" >            function (d, b) {</span> <span class="cstat-no" title="statement not covered" >for (var p in b) <span class="cstat-no" title="statement not covered" >if (Object.prototype.hasOwnProperty.call(b, p)) <span class="cstat-no" title="statement not covered" >d[p] = b[p]; </span></span></span>};</span>
...
var __assign = (this &amp;&amp; this.__assign) || <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    __assign = Object.assign || <span class="fstat-no" title="function not covered" >function(t) {</span></span>
...
}) : <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function(o, v) {</span></span>
<span class="cstat-no" title="statement not covered" >    o["default"] = v;</span>
});
var __importStar = (this &amp;&amp; this.__importStar) || function (mod) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (mod &amp;&amp; mod.__esModule) <span class="cstat-no" title="statement not covered" >return mod;</span>
    var result = {};
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mod != null) for (var k in mod) <span class="missing-if-branch" title="else path not taken" >E</span>if (k !== "default" &amp;&amp; Object.prototype.hasOwnProperty.call(mod, k)) __createBinding(result, mod, k);
...
var Client = /** @class */ (function () {
    ...
    Client.prototype.createProcessorToken = <span class="fstat-no" title="function not covered" >function (access_token, account_id, processor, cb) {</span>
...
<span class="cstat-no" title="statement not covered" >            return plaidRequest(this.openAPIClient.processorStripeBankAccountTokenCreate(options), cb);</span>
        }
        else <span class="cstat-no" title="statement not covered" >if (processor == 'apex') {</span>
<span class="cstat-no" title="statement not covered" >            return plaidRequest(this.openAPIClient.processorApexProcessorTokenCreate(options), cb);</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            var optionsWithProcessor = __assign(__assign({}, options), { processor: processor });</span>
<span class="cstat-no" title="statement not covered" >            return plaidRequest(this.openAPIClient.processorTokenCreate(optionsWithProcessor), cb);</span>
        }
    };
    // processor/stripe/bank_account_token/create
...
<span class="cstat-no" title="statement not covered" >        return this.createProcessorToken(access_token, account_id, 'stripe', cb);</span>
    ...
    Client.prototype.listPayments = function (options, cb) {
        return plaidRequest(this.openAPIClient.paymentInitiationPaymentList({
            client_id: this.client_id,
            secret: this.secret,
            count: (options === null || options === void 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >void 0 </span>: options.count) != null ? options.count : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
            cursor: (options === null || options === void 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >void 0 </span>: options.cursor) != null ? <span class="branch-0 cbranch-no" title="branch not covered" >options.cursor </span>: undefined,
        }), cb);
    };
    // processor/auth/get
    Client.prototype.getAuthProcessor = <span class="fstat-no" title="function not covered" >function (processor_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return plaidRequest(this.openAPIClient.processorAuthGet({</span>
            client_id: this.client_id,
    ...
    Client.prototype.getBalanceProcessor = <span class="fstat-no" title="function not covered" >function (processor_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return plaidRequest(this.openAPIClient.processorBalanceGet({</span>
            client_id: this.client_id,
            processor_token: processor_token,
            secret: this.secret,
        }), cb);
    ...
    Client.prototype.getIdentityProcessor = <span class="fstat-no" title="function not covered" >function (processor_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return plaidRequest(this.openAPIClient.processorIdentityGet({</span>
            client_id: this.client_id,
            processor_token: processor_token,
            secret: this.secret,
        }), cb);
    ...
    Client.prototype.sandboxItemSetVerificationStatus = <span class="fstat-no" title="function not covered" >function (access_token, account_id, verification_status, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return plaidRequest(this.openAPIClient.sandboxItemSetVerificationStatus({</span>
            access_token: access_token,
            account_id: account_id,
            client_id: this.client_id,
            secret: this.secret,
...
var PlaidError = /** @class */ (function (_super) {
    ...
    function PlaidError(body) {
        var _this = _super.call(this, body.error_code) || <span class="branch-1 cbranch-no" title="branch not covered" >this;</span>
...
var rejectWithPlaidError = function (data) {
    var _a, _b;
    var error = (_a = data.response) === null || _a === void 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >void 0 </span>: _a.data;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof error === 'object' &amp;&amp; error !== null) {
        error.status_code = (_b = data.response) === null || _b === void 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >void 0 </span>: _b.status;
        return new PlaidError(error);
    }
    // Unknown body type returned, return a standard API_ERROR
<span class="cstat-no" title="statement not covered" >    return new PlaidError({</span>
