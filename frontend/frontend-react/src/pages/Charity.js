...
class Charity extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Navbar />
        <h1 class='landingH1'>Who's lives do you want to change?</h1>
        <div class='row'>
          <div class='col'>
            <a
              class={'card ' + bagClass}
            ...
            >
              ...
              <input
                ...
                type='radio'
                checked={this.state.charity === 'boys and girls club'}
          ...
          <div class='col'>
            ...
            >
              ...
              <input
                id='bail project'
                type='radio'
                checked={this.state.charity === 'bail project'}
                onChange={this.radioChange}
              />
            </a>
          </div>
          <div class='col'>
            ...
            >
              ...
              <input
                id='feeding america'
                type='radio'
                checked={this.state.charity === 'feeding america'}
                onChange={this.radioChange}
              />
            </a>
          </div>
          ...
          <div class='col'>
            ...
            >
              ...
              <input
                id='room to read'
                type='radio'
                checked={this.state.charity === 'room to read'}
                onChange={this.radioChange}
              />
            </a>
          </div>
          <div class='col'>
            ...
            >
              ...
              <input
                id='united way'
                type='radio'
                checked={this.state.charity === 'united way'}
                onChange={this.radioChange}
              />
            </a>
          </div>
          <div class='col'>
            ...
            >
              ...
              <input
                id='water.org'
                type='radio'
                checked={this.state.charity === 'water.org'}
                onChange={this.radioChange}
              />
            </a>
          </div>
